...
export default function AdminStockSacarPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch("/api/admin/stock/outbound", {
        method: "POST",
        headers: {
      ...
      setMessage(
        `Egreso registrado correctamente ✅ ${productName ? `(${productName})` : ""}${typeof newStock === "number" ? ` · Nuevo stock: ${newStock}` : ""}`
      );
      ...
      setError(e.message || "Error guardando egreso");
    } finally {
      setSaving(false);
    }
  }
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-neutral-600">
            Descontá stock propio y registrá el movimiento manualmente
          </p>
        </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Ej: Producto roto, ajuste manual, uso interno, corrección de inventario..."
              />
            </div>
